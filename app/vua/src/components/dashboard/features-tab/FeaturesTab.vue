...
import VuesticIconVue
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconVue.vue'
import VuesticIconFree
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconFree.vue'
import VuesticIconFresh
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconFresh.vue'
import VuesticIconResponsive
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconResponsive.vue'
import VuesticIconRich
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconRich.vue'
import VuesticIconCleanCode
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconCleanCode.vue'
