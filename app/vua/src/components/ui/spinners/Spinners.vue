...
import VuesticSlider
  from '../../../vuestic-theme/vuestic-components/vuestic-slider/VuesticSlider.vue'
import VuesticIconFaster
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconFaster.vue'
import VuesticIconSlower
  from '../../../vuestic-theme/vuestic-components/vuestic-icon/VuesticIconSlower.vue'
