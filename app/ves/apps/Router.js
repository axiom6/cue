    ...
    { path:'/admin', name:'Admin', component:AppLayout, children:[
      ...
      { path:'statistics', name:'statistics', component:EmptyParentComponent, children:[
        ...
        { path:'ui', name:'ui', component:EmptyParentComponent, children:[
            { path:'typography', name:'typography', component:Typography }, // lazyLoading('ui/typography/Typography'),
            { path:'buttons', name:'buttons', component:Buttons, // lazyLoading('ui/buttons/Buttons'),
              meta:{ wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Buttons' } },
            { name:'color-pickers', path:'color-pickers', component:ColorPickers }, // lazyLoading('ui/color-pickers/ColorPickers'),
            { name:'timelines', path:'timelines', component:Timelines, // lazyLoading('ui/timelines/Timelines'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Timelines' } },
            { name:'dropdowns', path:'dropdowns', component:Dropdowns, // lazyLoading('ui/dropdowns/Dropdowns'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Dropdowns' } },
            { name:'notifications', path:'notifications', component:Notifications }, // lazyLoading('ui/notifications/Notifications'),
            { path:'icons', component:Icons,children:[ // lazyLoading('ui/icons/Icons')
                { name:'icon-sets', path:'', component:SetsList }, // lazyLoading('ui/icons/SetsList'), // Default route
                { name:'icon-set',  path:':name', component:IconSet, props:true } ] }, //lazyLoading('ui/icons/IconSet'),
            { name:'spinners', path:'spinners', component:Spinners },//lazyLoading('ui/spinners/Spinners'),
            { name:'grid', path:'grid', component:Grid }, // lazyLoading('ui/grid/Grid'),
            { name:'modals', path:'modals', component:Modals, // lazyLoading('ui/modals/Modals'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Modals' } },
            { name:'cards', path:'cards', component:Cards, // lazyLoading('ui/cards/Cards'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Cards' } },
            { name:'file-upload', path:'file-upload', component:FileUpload, // lazyLoading('ui/file-upload/FileUpload'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/File-Upload' } },
            { name:'tags', path:'tags', component:Tags, //lazyLoading('ui/tags/Tags'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Tags' } },
            { name:'tree-view', path:'tree-view', component:TreeView, // lazyLoading('ui/tree-view/TreeView'),
              meta:{   wikiLink:'https://github.com/epicmaxco/vuestic-admin/wiki/Tree-view' } },
            { name:'collapse', path:'collapse', component:Collapse }, // lazyLoading('ui/collapse/Collapse')
            { name:'filters', path:'filters',   component:Filters     } ] },  // lazyLoading('ui/filters/Filters')
